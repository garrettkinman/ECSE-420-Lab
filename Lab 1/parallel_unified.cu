...
int main(int argc, char* argv[]) {
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // step 2: allocating unified memory
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    
    Gate* gates_cuda;
    cudaMallocManaged((void**)&gates_cuda, sizeof(Gate) * input_length);    

    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // step 3: read in inputs from file
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    read_csv_to_gates(argv[1], gates_cuda, input_length);
